...
const TermsConditions = () => {
  return (
    <div className="max-w-4xl mx-auto p-6  bg-black shadow-lg rounded-lg">
      ...
      <h3 className="text-xl font-semibold text-white mt-6 mb-2">Services and Payments</h3>
      <p className="text-white -600 mb-4">
      ...
      <h3 className="text-xl font-semibold text-white mt-6 mb-2">Service Delivery</h3>
      ...
      <h3 className="text-xl font-semibold text-white mt-6 mb-2">Client Responsibilities</h3>
      <p className="text-white  mb-4">
      ...
      <h3 className="text-xl font-semibold text-white mt-6 mb-2">Code of Conduct</h3>
      <p className="text-white  mb-4">
      ...
      <h3 className="text-xl font-semibold text-white  mt-6 mb-2">Privacy</h3>
      <p className="text-white  mb-4">
      ...
      <h3 className="text-xl font-semibold text-white  mt-6 mb-2">Limitation of Liability and Disclaimer of Warranties</h3>
      <p className="text-white mb-4">
      ...
      <h3 className="text-xl font-semibold text-white  mt-6 mb-2">Amendments</h3>
      <p className="text-white  mb-4">
      ...
      <h3 className="text-xl font-semibold text-white  mt-6 mb-2">Contact Information</h3>
      <p className="text-white  mb-4">
        For any questions or concerns regarding these terms and conditions, please contact us at hello@luminarylines.com.
      </p>
