...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-5xl md:text-8xl font-bold text-center bg-clip-text text-transparent text-white from-neutral-50 to-neutral-400 bg-opacity-50 mt-36 -mb-30 md:mt-0 ">The Process</h2>
      </div>
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-transparent flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-transparent border border-neutral-700 p-2" />
              </div>
